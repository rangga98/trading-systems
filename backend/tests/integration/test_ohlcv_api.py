...
class TestOHLCVAPI:
    ...
    async def test_import_ohlcv_stock_not_found(self, async_client):
        """Test importing OHLCV for non-existent stock."""
        import_data = {
            "start_date": "2024-01-01",
            "end_date": "2024-01-31",
        }
    ...
    async def test_get_import_job_status(self, async_client, test_db_session):
        ...
        job = await job_service.create_job("BBCA.JK", "2024-01-01", "2024-01-31")
    ...
    async def test_get_import_job_not_found(self, async_client):
        ...
        response = await async_client.get("/api/v1/import-jobs/nonexistent-id")
